        ...
        <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-5">
            ...
            <h2 className="display leading-[1.12] tracking-[-0.03em]" style={{ fontSize: "clamp(32px,3.6vw,56px)" }}>
              <span className="italic" style={{ color: "#2563eb", fontWeight: 600 }}>스마텍 AI</span>가<br />
      ...
      <footer className="bg-paper text-ink">
        <div className="max-w-[1400px] mx-auto px-6 pt-16 pb-10">
          ...
          <div className="mt-8 pt-5 border-t hair text-[11px] mono dim flex items-center gap-2">
            <span>파트너사</span>
            <Link href="/partners" className="hover:text-edred transition-colors underline underline-offset-2">하우스맨</Link>
          </div>
