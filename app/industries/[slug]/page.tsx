...
const PUMP_PDF: Record<string, string> = {
  RV:          "/api/catalog?file=1.오일펌프_소형RV.pdf",
  E2M:         "/api/catalog?file=2.오일펌프_중대형E2M.pdf",
  E2S:         "/api/catalog?file=2-1오일펌프 중대형E2S.pdf",
  nES:         "/api/catalog?file=3.오일펌프_nES.pdf",
  nXDS:        "/api/catalog?file=4.스크롤펌프_소형nXDS.pdf",
  XDS:         "/api/catalog?file=5.스크롤펌프_중형XDS.pdf",
  EH:          "/api/catalog?file=6.부스터펌프EH.pdf",
  GXS:         "/api/catalog?file=7.산업용드라이펌프_GXS Dry.pdf",
  EXS:         "/api/catalog?file=7-1.산업용드라이_EXS.pdf",
  iXH:         "/api/catalog?file=8.반도체드라이_iXH.pdf",
  iXL:         "/api/catalog?file=9.반도체드라이_iXL.pdf",
  nXRi:        "/api/catalog?file=8-1.반도체드라이_nXRi.pdf",
  ELD500:      "/api/catalog?file=9-1.헬륨리크디텍터_ELD500.pdf",
  nEXT:        "/api/catalog?file=10.nEXT 터보펌프.pdf",
  "T-station": "/api/catalog?file=11.터보펌프_nEXT_Pumping_Station.pdf",
  STP:         "/api/catalog?file=12.터보펌프_STP.pdf",
  APG200:      "/api/catalog?file=13.저진공게이지_APG200.pdf",
  AIM200:      "/api/catalog?file=14.고진공게이지AIM200.pdf",
  WRG200:      "/api/catalog?file=15.저진공+고진공게이지_WRG200.pdf",
  "P4-P5":     "/api/catalog?file=16.디스플레이진공게이지_P4-P5.pdf",
  TIC:         "/api/catalog?file=17.컨트롤러_TIC.pdf",
  ADC:         "/api/catalog?file=18.컨트롤러_ADC.pdf",
  EMF:         "/api/catalog?file=19.미스트필터(EMF).pdf",
  Ultra19:     "/api/catalog?file=20.진공펌프오일_Ultra19.pdf",
  Fittings:    "/api/catalog?file=21.피팅_52~57페이지사용.PDF",
};
