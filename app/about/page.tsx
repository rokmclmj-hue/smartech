...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "스마텍",
    locale: "ko_KR",
    images: [{ url: "https://www.smartechvacuum.com/og-default.png", width: 1200, height: 630, alt: "스마텍 회사 소개" }],
  },
  twitter: {
...
const TIMELINE = [
  ...
  {
    year: "2018",
    title: "(주)스마텍 법인전환 및 천안 수리센터 개소",
    desc: "주식회사로 전환하며 수원 본사에 더해 충남 천안에 전문 수리·오버홀 센터 개소. 전국 A/S 대응 체계 완성.",
  },
  {
    year: "2026",
    title: "디지털 플랫폼 오픈",
