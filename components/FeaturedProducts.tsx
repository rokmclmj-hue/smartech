...
function imageForCategory(category: string): string {
  ...
  if (c.includes("소형") && c.includes("e2m")) return "/images/products/e2m-small.png";
  if (c.includes("e2m")) return "/images/products/e2m-large.png";
  if (c.includes("nes")) return "/images/products/nes.jpeg";
  if (c.includes("nxds")) return "/images/products/xds.jpeg";
  if (c.includes("xds")) return "/images/products/xds35.png";
  ...
  if (c.includes("t-station") || c.includes("터보펌핑스테이션") || (c.includes("next") && c.includes("station"))) return "/images/products/t-station.jpeg";
