...
// Source: Edwards PumpCalc 실측 BP Speed 직접 추출
//   data720291.csv — Air, 1093L, 5.874m², KF40 1m 2-bend, 60Hz
//   (col=BackingPump Pressure & Speed) → 펌프 입구 압력/속도 쌍 = 실제 속도 곡선
// 컨트롤러 내장으로 50/60Hz 공용 — speed50Hz=speed60Hz=정격속도
// nXR30i: 30min 시험에서 0.496mbar 이하 미도달 → 이하 구간은 로그-선형 외삽
// pumpCalcFactor 1.08: PumpCalc CSV 밸브 구간(0.1m NW40) + SS+Nitrile 실링 미반영 보정
//   (nXR40i 검증: 1.08→28.0분 vs 기준 28.2분, nXR60i: 23.0분 vs 23.0분, nXR90i: 22.5분 vs 22.3분)
...
const nXRi: PumpModel[] = [
  {
    ...
    pumpCalcFactor: 1.08,
    speedCurve: [
      [1005.16,10.00],[680.86,9.92],[464.20,13.63],[324.16,18.87],
      [215.05,21.14],[150.18,22.59],[104.88,23.84],[69.58,24.97],
      [48.59,25.55],[32.23,25.85],[22.51,25.72],[14.93,25.44],
      [10.44,25.05],[6.96,24.33],[4.91,23.34],[3.31,21.67],
      [2.25,19.78],[1.55,17.30],[1.07,14.79],[0.728,11.26],
      [0.496,8.73],[0.299,6.32],[0.150,3.67],[0.100,2.74],[0.07743,0.0],
    ],
  },
  {
    ...
    pumpCalcFactor: 1.08,
    speedCurve: [
      [1001.07,10.00],[628.36,9.77],[403.29,13.89],[254.17,21.07],
      [160.19,25.01],[100.96,27.98],[60.45,30.64],[38.10,32.21],
      [24.01,32.86],[15.13,34.55],[9.537,35.69],[6.011,35.60],
      [3.793,35.31],[2.403,34.55],[1.532,33.12],[0.946,29.40],
      [0.591,26.47],[0.386,24.65],[0.242,22.41],[0.148,19.63],
      [0.0941,16.76],[0.0300,0.0],
    ],
  },
  {
    ...
    pumpCalcFactor: 1.08,
    speedCurve: [
      [999.47,12.09],[592.46,12.09],[370.09,12.07],[222.19,14.39],
      [133.04,25.57],[79.65,37.80],[50.20,41.75],[30.06,43.22],
      [17.98,46.74],[10.75,48.41],[6.416,49.14],[4.028,49.20],
      [2.402,48.69],[1.440,47.19],[0.866,45.22],[0.530,42.67],
      [0.326,40.58],[0.194,38.19],[0.118,34.46],[0.0722,29.32],
      [0.0432,22.71],[0.0300,0.0],
    ],
  },
  {
    ...
    pumpCalcFactor: 1.08,
    speedCurve: [
      [1001.04,10.04],[604.15,9.47],[357.95,9.77],[225.60,12.52],
      [135.07,21.80],[80.87,34.26],[48.41,45.86],[28.94,52.72],
      [18.20,58.58],[10.86,66.36],[6.465,73.78],[3.838,78.33],
      [2.392,80.47],[1.418,78.79],[0.841,76.11],[0.528,71.70],
      [0.316,65.43],[0.188,53.15],[0.114,43.10],[0.0689,34.00],
      [0.0419,25.11],[0.0300,0.0],
    ],
  },
  {
