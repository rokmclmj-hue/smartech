...
const DS = StyleSheet.create({
  ...
  toFromLineGray: { fontSize: 7, color: "#888888", marginBottom: 2, lineHeight: 1.5 },
    ...
    el(Page, { size: "A4", style: S.page },
      ...
      el(View, { style: DS.toFromRow },
        ...
        el(View, { style: DS.fromBox },
          ...
          el(Text, { style: DS.toFromLineGray }, `사업자번호: ${SMARTECH_COMPANY.bizNo}`),
    ...
    el(Page, { key: "main", size: "A4", style: S.page },
      ...
      el(View, { style: DS.toFromRow },
        el(View, { style: DS.toBox },
          ...
          data.toName  ? el(Text, { style: DS.toFromLine }, `담당자: ${data.toName}${data.toTitle ? ` ${data.toTitle}님` : " 님"}`) : null,
