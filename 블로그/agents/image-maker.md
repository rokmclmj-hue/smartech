...
#### 🚫 본문 이미지 브랜드 푸터 완전 금지
- image-01.png, image-02.png 등 본문 이미지에는 브랜드 정보 일절 삽입 금지
- 전화번호(031-204-7170), 웹사이트(smartechvacuum.com), 회사명(SMARTECH VACUUM) 모두 금지
- 이미지 내용은 데이터·비교·다이어그램·강조 텍스트만으로 구성한다.
