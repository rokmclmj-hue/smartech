...
output_dir = r"c:\Users\rokmc\Desktop\블로그\output\클로드 코드의 핵심 기능 5가지\images"
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .v-line {
    ...
    width: 2px;
    height: 20px;
    background: rgba(240,160,255,0.4);
  }
  .h-line {
    position: absolute;
    top: 20px;
    ...
    width: 440px;
    height: 2px;
    background: rgba(240,160,255,0.25);
  }
  .agent-col {
    display: flex;
    flex-direction: column;
  ...
  .agent-tick {
    width: 2px;
    height: 20px;
    background: rgba(240,160,255,0.3);
  }
  .agent-box {
    width: 240px;
    background: rgba(88,166,255,0.08);
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .phase.think {
    ...
    border: 1.5px solid rgba(251,211,141,0.35);
  }
  .phase.output {
    background: rgba(104,211,145,0.08);
    border: 1.5px solid rgba(104,211,145,0.3);
  }
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .card.card-hook {
    ...
    background: rgba(251,211,141,0.06);
  }
...
<body>
  ...
  <div class="grid">
    ...
    <div class="card card-slash">
      ...
      <div class="path">.claude/commands/</div>
      <ul>
        <li>마크다운으로 정의</li>
        <li>코드 리뷰 규칙</li>
        <li>배포 절차 표준화</li>
    ...
    <div class="card card-hook">
      ...
      <div class="path">settings.json</div>
      <ul>
...
images = [
    ...
    ("image-01.png", image01_html, 1080, 640),
    ("image-02.png", image02_html, 1080, 680),
    ("image-03.png", image03_html, 1080, 620),
    ("image-04.png", image04_html, 1080, 660),
]
