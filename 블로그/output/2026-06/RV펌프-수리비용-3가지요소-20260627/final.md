...
스마텍은 Edwards RV3/5/8/12 전 모델 분해 수리를 자체 진행합니다. 접수 후 분해 점검 → 사진 첨부 견적 → 승인 후 작업 순으로 진행하며, 수리 완료 후 성능 테스트(도달 진공도 측정) 결과를 함께 제공합니다.

분해 전 단계에서 오염 가스 누출 위험이 있는 펌프는 별도 안전 절차를 거칩니다. 화학물질 공정에 사용한 펌프는 접수 시 반드시 사전 고지 부탁드립니다. 수리 완료 후에는 도달 진공도 측정 결과를 기록지로 제공합니다.

---

RV 오일로터리펌프 수리 견적, 현장 출장 점검, Edwards 정품 서비스 키트 구매 상담은 스마텍에서 제공합니다. RV3/RV5/RV8/RV12 전 모델 접수 가능합니다.
