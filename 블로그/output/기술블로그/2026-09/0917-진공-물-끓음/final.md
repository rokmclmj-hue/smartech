...
![진공에서 물이 끓는 원리](./images/thumbnail.png)
...
![압력과 끓음 조건 개념도](./images/사진1.png)

NIST는 [증기압](https://www.nist.gov/glossary-term/36246)을 액체 또는 고체와 평형을 이루는 증기의 압력으로 정의합니다. 액체의 온도가 올라가면 일반적으로 증기압도 올라갑니다. 증기압이 액체 표면을 누르는 주변 압력과 같아지면 액체 내부에서 기포가 유지될 수 있고, 이것이 끓음으로 나타납니다.

대기압 101.325 kPa에서 물의 정상 끓는점은 [NIST 자료](https://webbook.nist.gov/cgi/cbook.cgi?ID=C7732185&Type=TBOIL) 기준 373.15 K, 약 100°C입니다. 이 값은 “물이 항상 100°C에서 끓는다”는 뜻이 아니라, 정해진 압력에서의 기준값입니다. 압력솥에서 끓는점이 올라가고 진공 챔버에서 내려가는 것은 같은 원리의 반대 방향 사례입니다.

## 증발과 끓음은 어떻게 다를까?

![증발·끓음·승화 구분 카드](./images/사진2.png)
...
![진공에서 물의 증발과 냉각 흐름](./images/사진3.png)
