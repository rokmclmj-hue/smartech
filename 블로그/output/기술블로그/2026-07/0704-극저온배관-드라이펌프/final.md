...
![극저온 배관 재배기 현장의 터보펌핑 시스템(T-station) 구성 사례](./images/field-1.png)

목표 도달진공도가 스크롤 드라이펌프의 한계보다 낮은 연구용·파일럿 규모 VIP 배관이라면, 위 사진처럼 터보펌핑 시스템(T-station)을 함께 구성하는 경우도 있습니다. 로터리+부스터+터보, 또는 드라이+터보 조합으로 백킹 펌프 뒤에 터보분자펌프를 얹어 스크롤 단독으로는 도달하기 어려운 고진공 영역까지 재배기합니다.
